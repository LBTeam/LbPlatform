		...
		fill: function() {
			...
			this.picker.find('.datetimepicker-days thead th:eq(1)')
				...
				if (this.formatViewType == "time") {
                    	...
                    	var _ddt_d = new Date(),
                            _ddt_year = _ddt_d.getUTCFullYear(),
                            _ddt_month = _ddt_d.getUTCMonth(),
                            _ddt_dayMonth = _ddt_d.getUTCDate();
						this.picker.find('.datetimepicker-hours thead th:eq(1)')
								.text(_ddt_dayMonth + ' ' + dates[this.language].months[_ddt_month] + ' ' + _ddt_year);
						this.picker.find('.datetimepicker-minutes thead th:eq(1)')
								.text(_ddt_dayMonth + ' ' + dates[this.language].months[_ddt_month] + ' ' + _ddt_year);
				}
